...
def is_valid(customer_account_number):
    try:
        ...
        customer_database = open(
            "./database/Customer/customerDatabase.txt", "a")
...
def delete_customer_account(identity, choice):
    ...
    if flag == 1:
        output_message = "Account with account no." + \
            str(identity) + " closed successfully!"
        if choice == 1:
...
def transaction(identity, amount, choice):  # choice 1 for deposit; choice 2 for withdraw
    ...
    for line in customer_database:
        if identity == line.replace("\n", ""):
            ...
            if choice == 2 and balance - amount < 1000:  # Minimum balance 10000
                return -1
            else:
                if choice == 1:
                    balance += amount
...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to Rcpit BANK")
        ...
        self.Canvas1.place(relx=0.190, rely=0.228,
                           relheight=0.496, relwidth=0.622)
...
class adminMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1.place(relx=0.081, rely=0.081,
                               relheight=0.415, relwidth=0.848)
        ...
        self.Button1.place(relx=0.667, rely=0.195, height=34,
        ...
        self.Button2.place(relx=0.04, rely=0.195, height=34,
                           width=181, bordermode='ignore')
        ...
        self.Button3 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 ...
                                 command=self.exit)
        self.Button3.place(relx=0.667, rely=0.683, height=34,
                           width=181, bordermode='ignore')
        ...
        self.Button4.place(relx=0.04, rely=0.439, height=34,
                           width=181, bordermode='ignore')
        ...
        self.Button5.place(relx=0.667, rely=0.439, height=34,
                           width=181, bordermode='ignore')
        ...
        self.Button6.place(relx=0.04, rely=0.683, height=34,
                           width=181, bordermode='ignore')

        global Frame1
        Frame1 = tk.Frame(window, relief='groove',
                          borderwidth="2", background="#fffffe")
...
class createCustomerAccount:
    def __init__(self, window=None):
        ...
        self.Radiobutton1.place(relx=0.511, rely=0.174,
                                relheight=0.057, relwidth=0.151)
        ...
        self.Radiobutton3.place(relx=0.481, rely=0.397,
                                relheight=0.055, relwidth=0.175)
        ...
        self.Radiobutton4.place(relx=0.706, rely=0.397,
                                relheight=0.055, relwidth=0.175)
        ...
        if is_valid(customer_account_number) and customer_account_number.isnumeric():
            if name != "":
                if account_type == "Savings" or account_type == "Current":
                                        ...
                                        if PIN.isnumeric() and PIN.__len__() == 4:
                                            if confirm_PIN == PIN:
                                                if initial_balance.isnumeric():
                                                    ...
                                                    Error.setMessage(
                                                        self, message_shown="Invalid balance!")
                                                    return
                                            else:
                                                Error(Toplevel(self.master))
                                                Error.setMessage(
                                                    self, message_shown="PIN mismatch!")
                                                return
                                        else:
                                            Error(Toplevel(self.master))
                                            Error.setMessage(
                                                self, message_shown="Invalid PIN!")
                                            return
                                    else:
                                        Error(Toplevel(self.master))
                                        Error.setMessage(
                                            self, message_shown="Enter KYC document!")
                                        return
                                else:
                                    Error(Toplevel(self.master))
                                    Error.setMessage(
                                        self, message_shown="Enter Nationality!")
                                    return
                            else:
                                Error(Toplevel(self.master))
                                Error.setMessage(
                    ...
                    Error(Toplevel(self.master))
                    Error.setMessage(
                        self, message_shown="Select account type!")
                    return
            else:
                Error(Toplevel(self.master))
...
class customerMenu:
    def __init__(self, window=None):
        ...
        global Frame1_1_2
        Frame1_1_2 = tk.Frame(window, relief='groove',
                              borderwidth="2", background="#fffffe")
        Frame1_1_2.place(relx=0.081, rely=0.547,
                         relheight=0.415, relwidth=0.848)
        ...
        if amount.isnumeric():
            if 25000 >= float(amount) > 0:
                ...
                if float(amount) > 25000:
                    ...
                    Error.setMessage(
                        self, message_shown="Positive value expected!")
                return
        else:
            Error(Toplevel(self.master))
